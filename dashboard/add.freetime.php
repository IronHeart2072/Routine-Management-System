				...
				<fieldset>
					...
					<div class="form-group">
						<label class="control-label">Day</label>  <br>
					  	<input type="checkbox" name="check_list[]" value="0">Sunday<br>
						<input type="checkbox" name="check_list[]" value="1">Monday<br>
						<input type="checkbox" name="check_list[]" value="2">Tuesday <br>
						<input type="checkbox" name="check_list[]" value="3">Wednesday<br>
						<input type="checkbox" name="check_list[]" value="4">Thursday <br>
						<input type="checkbox" name="check_list[]" value="5">Friday<br>
						<input type="checkbox" name="check_list[]" value="6">Saturday <br>
					</div>	
