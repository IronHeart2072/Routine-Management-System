                        ...
                        <form class="form-horizontal" action="" method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="first">First Lecutre</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class=" control-label" for="second">Second Lecture</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label" for="third">Third Lecture</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label" for="fourth">Fourth Lecture</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label" for="fifth">Fifth Lecture</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label" for="sixth">Sixth Lecture</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label" for="seventh">Seventh Lecture</label>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label" for="eight">Eight Lecture</label>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="submit"></label>
                                        ...
                                        <button id="submit" name="submit" class="btn btn-success">Add Timimg</button>
